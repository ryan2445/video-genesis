    ...
    <validation-observer ref="validationObservation" v-slot="{ invalid }">
        <v-form ref="confirmAuthForm" @submit.prevent="onSubmit">
            ...
            <validation-provider name="Verification code"
                ...
                <v-text-field id="confirmAuth" :error="!!errors" :error-messages="errors"
                    placeholder="Code" :success="!errors" v-model="code">
                </v-text-field>
            </validation-provider>
            ...
            <div class="text-center">
                <div class="my-2">
                    <v-btn @click="onSubmit" class="white--text" color="orange lighten-1"
                        :disabled="invalid">
                        Submit
                    </v-btn>
                </div>
