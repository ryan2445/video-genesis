...
export default {
    ...
    methods: {
        ...
        async onUpload() {
            ...
            const key = encodeURIComponent(this.video.name)

            const read = new FileReader()

            read.addEventListener('load', async (event) => {
            ...
            read.addEventListener('progress', (event) => {
            ...
            read.readAsBinaryString(this.video)
        }
    }
}
</script>
