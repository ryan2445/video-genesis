    ...
    <v-row justify="center">
        <v-col :cols="!!playlist ? '8' : '12'">
            <template v-if="!loading">
                <video-container :video="video" :audio="videoAudio"
                    :start-time="startTime" :video-data="videoData" :autoplay="!!playlist"
        ...
        <v-col cols="4">
            <playlist-player v-if="playlist" :playlist="playlist" :index="index"
